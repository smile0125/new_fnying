(function () {
    ...
    var stageDom = document.getElementById((window._mrmcp || {})['script_id'] || "Mugeda_5bff5160ecb65e1edc5f3842")

    _mrmcp = (typeof _mrmcp == 'undefined') ? {} : _mrmcp;
_mrmcp['campaign_id'] = 'none';
_mrmcp['owner_id'] = '5bd819e5e49bc65e132209f5';
_mrmcp['creative_id'] = '5bff5160ecb65e1edc5f3842';
...
_mrmcp['type'] = 'smart';
_mrmcp['title'] = 'CCVT新手教程';
_mrmcp['build_number'] = parseInt('1405');
_mrmcp['publish_time'] = '11/29/2018 10:41:52 AM';
_mrmcp['last_modified'] = '';
_mrmcp['track_bot'] = 'http://cdn.mugeda.com/media/pages/track/track_20131030.html';
var version = _mrmcp['version'] = _mrmcp['version'] != null ? _mrmcp['version'] : '0.14.5';
...
window['Mugeda']['Loader'] = function (dom, hasScript, _mrmcp) {
    ...
    if(!Mugeda['css3PlayerLoaded']) {
        ...
        loadRes(1, jsPath + that.crid + ".js?publishTime=1543459312251", [], undefined, function(callback){
            var chk = function(){
...
Mugeda.Loader.prototype.start = function () {
    if (2 == Mugeda.css3PlayerLoaded) {
        ...
        Mugeda['startAnimation']("id_" + this.crid, false ? "actions_" + this.crid + ".js?publishTime=1543459312251" : "", a, this.resDir, this.name, null, this._mrmcp)
    }
    else {
